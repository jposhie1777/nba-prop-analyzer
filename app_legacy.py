...
STAT_MAP = {
    ...
    "steals": "stl", "blocks": "blk", "points_rebounds": "pts_reb",
    "points_assists": "pts_ast", "rebounds_assists": "reb_ast",
...
st.write("📊 Player stats rows:", len(player_stats))
st.write("🏟️ Games rows:", len(games_df))
st.write("💸 Odds rows:", len(odds_df))
st.dataframe(odds_df.head(5))
...
# Helper: map tab to label (Streamlit doesn't expose active tab directly)
tab1, tab2, tab3, tab4 = tabs
current_tab = None

# Render tabs one at a time lazily
...
st.session_state.active_tab = current_tab or tab_labels[0]
