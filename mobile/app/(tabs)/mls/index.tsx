...
export default function MlsHome() {
  const { colors } = useTheme();

  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <View style={[styles.hero, { borderColor: colors.border.subtle }]}> 
        <Text style={styles.eyebrow}>MLS ANALYTICS</Text>
      ...
      <Tile
        ...
        route="/(tabs)/mls/team-master-metrics"
        icon="grid-outline"
        accent="#22D3EE"
      />
