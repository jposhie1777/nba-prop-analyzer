...
const st = StyleSheet.create({
  ...
  cardName: { color: "#E5E7EB", fontSize: 16, fontWeight: "800", flex: 1 },
  cardHand: { color: "#64748B", fontSize: 12, fontWeight: "700" },
  cardOdds: { color: "#F59E0B", fontSize: 14, fontWeight: "800" },
  cardSubRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  cardBook: { color: "#64748B", fontSize: 10, fontWeight: "600" },
  cardVs: { color: "#94A3B8", fontSize: 11, fontWeight: "600", flex: 1 },
