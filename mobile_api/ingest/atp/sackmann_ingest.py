...
def rebuild_sackmann_features(client: Optional[bigquery.Client] = None) -> None:
    ...
    _run_query(
        ...
        SELECT
          ...
          REGEXP_REPLACE(LOWER(TRIM(winner_name)), r'[^a-z0-9]', '') AS player_name_norm,
          winner_id AS player_id,
          loser_name AS opponent_name,
          REGEXP_REPLACE(LOWER(TRIM(loser_name)), r'[^a-z0-9]', '') AS opponent_name_norm,
        ...
        SELECT
          ...
          REGEXP_REPLACE(LOWER(TRIM(loser_name)), r'[^a-z0-9]', '') AS player_name_norm,
          loser_id AS player_id,
          winner_name AS opponent_name,
          REGEXP_REPLACE(LOWER(TRIM(winner_name)), r'[^a-z0-9]', '') AS opponent_name_norm,
