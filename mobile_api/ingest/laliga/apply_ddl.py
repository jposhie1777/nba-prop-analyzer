...
def _dataset() -> str:
    return os.getenv("LALIGA_DATASET", "laliga_data")


def _location() -> str:
    return os.getenv("LALIGA_BQ_LOCATION", "US")
...
def main() -> None:
    ...
    tables = [
        ("teams", "LaLiga teams payload snapshots from BallDontLie API"),
        ("players", "LaLiga players payload snapshots from BallDontLie API"),
        ("rosters", "LaLiga team roster payload snapshots from BallDontLie API"),
        ("standings", "LaLiga standings payload snapshots from BallDontLie API"),
        ("matches", "LaLiga matches payload snapshots from BallDontLie API"),
        ("match_events", "LaLiga match events payload snapshots from BallDontLie API"),
        ("match_lineups", "LaLiga match lineups payload snapshots from BallDontLie API"),
    ]
