...
try:
    ...
    from mobile_api.ingest.mls.client import fetch_paginated, fetch_single

DATASET = os.getenv("MLS_DATASET", "mls_data")
LOCATION = os.getenv("MLS_BQ_LOCATION", "US")

TABLE_TEAMS = os.getenv("MLS_TEAMS_TABLE", f"{DATASET}.teams")
TABLE_PLAYERS = os.getenv("MLS_PLAYERS_TABLE", f"{DATASET}.players")
TABLE_ROSTERS = os.getenv("MLS_ROSTERS_TABLE", f"{DATASET}.rosters")
TABLE_STANDINGS = os.getenv("MLS_STANDINGS_TABLE", f"{DATASET}.standings")
TABLE_MATCHES = os.getenv("MLS_MATCHES_TABLE", f"{DATASET}.matches")
TABLE_MATCH_EVENTS = os.getenv("MLS_MATCH_EVENTS_TABLE", f"{DATASET}.match_events")
TABLE_MATCH_LINEUPS = os.getenv("MLS_MATCH_LINEUPS_TABLE", f"{DATASET}.match_lineups")
